    ...
    <>
      ...
      <section class="legal reveal">
        <div class="container legal-content">
          ...
          <p class="lead">Effective date: January 11, 2026</p>

          <p>
            By using the Waktu Solat app, you agree to these Terms of Service.
            If you do not agree, please do not use the app.
          </p>

          <h2>Use of the app</h2>
          <p>
            Waktu Solat provides prayer time information and related utilities.
            The app is provided "as is" without warranties of any kind. While we
            strive for accuracy, prayer times may vary by source and location
            settings.
          </p>
