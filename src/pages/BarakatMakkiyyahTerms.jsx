...
export default function BarakatMakkiyyahTerms() {
  ...
  return (
    <>
      <SEO title={title} description={description} path="/barakat-makkiyyah/terms" type="article" />
      <section className="legal reveal">
        <div className="container legal-content">
          ...
          <p className="lead">Effective date: January 12, 2026</p>

          <p>
            By using the Barakat Makkiyyah app, you agree to these Terms of Service. If you do not
            agree, please do not use the app.
          </p>

          <h2>Use of the app</h2>
          <p>
            Barakat Makkiyyah provides offline text and audio for recitation. The app is provided
            “as is” without warranties of any kind. While we strive for accuracy, users should
            verify content based on their own sources.
          </p>
