      ...
      <section className="legal reveal">
        <div className="container legal-content">
          ...
          <ul>
            ...
            <li>
              <strong>Theme setting:</strong> Your chosen appearance (light, dark, or system
              default)
            </li>
            <li>
          ...
          <ul>
            <li>All data is stored locally on your device using encrypted device storage</li>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>Internet</td>
                <td>
                  Required only for opening external links (email, website) when you tap on them.
                  The App itself does not transmit any data.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>To continue audio playback when the App is in the background</td>
              </tr>
              <tr>
                <td>Wake Lock</td>
                <td>To prevent the device from sleeping during audio playback</td>
              </tr>
              <tr>
                <td>Vibrate</td>
          ...
          <p>
            <strong>We do not share any data with third parties</strong> because we do not collect
            any data. Your preferences remain on your device and are never transmitted elsewhere.
          </p>
          ...
          <ul>
            ...
            <li>
              To delete all stored preferences, go to your device Settings &gt; Apps &gt; Barakat
              Makkiyyah &gt; Storage &gt; Clear Data
            </li>
          ...
          <p>
            The App contains religious educational content suitable for all ages. Since the App does
            not collect any personal data, it complies with the Children&apos;s Online Privacy
            Protection Act (COPPA) and similar regulations.
          </p>

          <h2>9. External Links</h2>
          <p>
            The App may contain links to external websites (such as the developer&apos;s website or
            email). These links open in your device&apos;s browser or email app. We are not
          ...
          <ul>
            ...
            <li>
              <strong>Security practices:</strong> Data is encrypted in transit (not applicable as
              no data is transmitted); Data cannot be deleted by user request (preferences can be
              cleared via device settings)
            </li>
          </ul>

          <h2>13. Contact Us</h2>
          <p>
            If you have questions or concerns about this privacy policy or the App&apos;s privacy
            practices, please contact:
          </p>
          <p>
            <strong>Rusdy Ahmad</strong>
            <br />
            Email: <a href="mailto:rusdyahmad@gmail.com">rusdyahmad@gmail.com</a>
            <br />
            Website:{" "}
            <a href="https://rusdy.com/barakat-makkiyyah" target="_blank" rel="noopener noreferrer">
