      ...
      <section class="case-hero reveal">
        <div class="container case-hero-inner">
          <div>
            ...
            <p class="lead">
              A fully offline Barakat Makkiyyah library featuring 805 selawat,
              guided recitation methods (hizb or one-third), multilingual UI,
              and on-device audio playback so readers can follow the text with
            ...
            <div class="case-meta">
              ...
              <div>
                ...
                <span class="meta-value">
                  Offline library, hizb + 1/3 filters, audio with seek +
                  background playback, search, adjustable typography,
              ...
              <div>
                ...
                <span class="meta-value">
                  Bundled Barakat Makkiyyah text, Arabic introduction, and audio
                  assets
                </span>
              </div>
            </div>
            ...
            <div class="case-actions" style={{ marginTop: "10px" }}>
              <a
                class="btn"
          ...
          <div class="case-media">
            <img
              src="/projects/barakat/icon.png"
              alt="Barakat Makkiyyah app icon"
              loading="lazy"
            />
          </div>
        </div>
        ...
        <div class="container case-grid">
          <div class="case-card">
            ...
            <ul>
              ...
              <li>
                Recitation guide with hizb (7 days) and one-third (3 days)
                reading paths.
              </li>
              <li>
                On-device audio playback with play, pause, stop, and seek
                controls.
              </li>
              <li>
          ...
          <div class="case-card">
            ...
            <ul>
              ...
              <li>
                Audio playback handled entirely from bundled assets with seek
                support.
              </li>
              <li>
              ...
              <li>
                FlatList + sticky controls for fast navigation through long
                content lists.
              </li>
            </ul>
          </div>
      ...
      <section class="case-section reveal">
        <div class="container case-stack">
          ...
          <div class="case-tags">
            ...
            <span class="tag">Expo Audio</span>
            <span class="tag">AsyncStorage</span>
            <span class="tag">Multilingual UI</span>
          </div>
        </div>
      </section>
